...
class Schedule:
    ...
    def __init__(self, id: str, time: time, focus: str, group_ids: List[int], enabled: bool = True):
        self.id = id
        self.time = time
        self.focus = focus
...
def add_schedule_job(schedule_id: str, hour: int, minute: int, group_ids: list[int], focus: str) -> None:
