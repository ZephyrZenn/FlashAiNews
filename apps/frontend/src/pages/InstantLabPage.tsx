...
const InstantLabPage = () => {
  ...
  return (
    <Layout>
      <div className="h-full overflow-hidden p-4 md:p-12 flex flex-col items-center">
        <div className="w-full max-w-2xl bg-white rounded-2xl md:rounded-[3rem] border border-slate-100 p-6 md:p-10 shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-500">
          {/* Header */}
          <div className="mb-6 md:mb-10 flex items-center gap-3 md:gap-4">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-indigo-600 rounded-xl md:rounded-[1.5rem] flex items-center justify-center text-white shadow-lg shadow-indigo-100">
          ...
          <div className="space-y-6 md:space-y-8">
            {/* Focus input */}
            <div>
              <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 md:mb-3 ml-1 md:ml-2">
                用户关注点 (可选)
              </label>
              <textarea
                ...
                className="w-full bg-slate-50 border-none rounded-2xl md:rounded-[2rem] px-4 md:px-6 py-4 md:py-5 text-sm focus:ring-2 focus:ring-indigo-500/20 resize-none outline-none h-28 md:h-32"
              />
            </div>
              ...
              <div className="flex flex-wrap gap-2 px-1">
                {allGroups.map((group) => (
                  <button
                    ...
                    className={`px-4 md:px-5 py-2.5 md:py-3 rounded-xl md:rounded-2xl text-xs font-bold transition-all border min-h-[44px] ${
            ...
            <button
              ...
              className="w-full py-4 md:py-5 bg-indigo-600 text-white rounded-2xl md:rounded-[2rem] font-black shadow-xl shadow-indigo-100 hover:bg-indigo-700 disabled:opacity-40 transition-all flex items-center justify-center gap-2 md:gap-3 text-base md:text-lg mt-4 min-h-[44px]"
            >
