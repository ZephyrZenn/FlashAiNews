...
2. **Maintain Brevity**: Your summary should be concise, ideally between 800-1000 words. Use clear and direct language to ensure it is easily digestible for a quick read.

3. **Output Format**: Present your summary in JSON format with two attributes: "title" and "content". The "title" should be a brief descriptor of the summary, while the "content" should contain the synthesized overview using clean Markdown formatting.

4. **Avoid XML Tags**: Ensure that your output does not contain any XML tags, only the specified JSON format.

Next, you'll receive other prompt to follow. But instructions above should always be followed.
{instruction}
</instruction>
<examples>
<example>
